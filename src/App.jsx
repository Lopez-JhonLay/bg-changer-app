    ...
    <div className="w-full h-screen duration-1000" style={{ background: color }}>
      <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-2 px-2">
        <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
          ...
          <button
            onClick={() => setColor("linear-gradient(to right, red, green)")}
            className="outline-none px-4 py-1 rounded-full shadow-lg text-white"
          ...
          <button
            onClick={() => setColor("linear-gradient(to right, red, blue)")}
            className="outline-none px-4 py-1 rounded-full shadow-lg text-white"
          ...
          <button
            onClick={() => setColor("linear-gradient(to right, green, blue)")}
            className="outline-none px-4 py-1 rounded-full shadow-lg text-white"
            style={{ backgroundImage: "linear-gradient(to right, green, blue)" }}
          >
            Green & Blue Gradient
          </button>
        </div>
